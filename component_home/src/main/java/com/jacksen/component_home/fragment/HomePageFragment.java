package com.jacksen.component_home.fragment;
...
import com.base.lib.fragment.BaseRootFragment;
import com.jacksen.component_home.BannerImageLoader;
import com.jacksen.component_home.R;
import com.jacksen.component_home.R2;
import com.jacksen.component_home.adapter.ArticleListAdapter;
...
import com.jacksen.component_home.presenter.HomePagerContract;
import com.jacksen.component_home.presenter.HomePagerPresenter;
...
public class HomePageFragment extends BaseRootFragment<HomePagerPresenter> implements HomePagerContract.View, OnRefreshListener, OnLoadMoreListener {
    ...
    protected void initListener() {
        ...
        mAdapter.setOnItemChildClickListener((adapter, view, position) -> {
            switch (view.getId()) {
                //收藏文章
                case R2.id.item_article_pager_like_iv:
                    mPresenter.doCollectClick(adapter, position);
                    break;
                case R2.id.item_article_pager_chapterName:
                    mPresenter.doTurnChapterKnowledgePager(adapter, position);
                    break;
                case R2.id.item_article_pager_tag_red_tv:
    ...
    private void initRecyclerView() {
        ...
        mBanner = mHeaderGroup.findViewById(R2.id.head_banner);
