package com.jacksen.wanandroid.model.http.cookies;
...
public class PersistentCookieStore {
    ...
    private String encodeCookie(OkHttpCookies cookie) {
        ...
        try {
            ...
            KLog.e("IOException in encodeCookie", e);
            return null;
        }
    ...
    private Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            KLog.e("IOException in decodeCookie", e);
        } catch (ClassNotFoundException e) {
            KLog.e("ClassNotFoundException in decodeCookie", e);
        }
