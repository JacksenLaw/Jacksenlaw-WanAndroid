...
public class CommonUtils {
    ...
    public static void showSnackMessage(View parent, String message) {
        SnackbarUtils.showShortSnackbar(parent, message,
                ContextCompat.getColor(Utils.getContext(), R.color.white),
                ContextCompat.getColor(Utils.getContext(), R.color.colorSnackBar),
                "好哒",
                ContextCompat.getColor(Utils.getContext(), R.color.colorSnackBarAction),
                v -> SnackbarUtils.dismissSnackbar());
    }
