...
//                .checkBoxPromptRes(R.string.app_name, false, null)
     ...
     * @return MaterialDialog.Builder
     */
    public static MaterialDialog.Builder showSelectDialog(Context context, String title, String[] arrays, final MaterialDialog.ListCallback callback) {
        MaterialDialog.Builder builder = new MaterialDialog.Builder(context)
                .items(arrays)
...
//        positiveAction.setEnabled(false); // disabled by default
     ...
     * @return MaterialDialog.Builder
     */
    public static MaterialDialog.Builder showInputDialog(final Context context, String title, String content, String hint, String prefill, final MaterialDialog.InputCallback callback) {
